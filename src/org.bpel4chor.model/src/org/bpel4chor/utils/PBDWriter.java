...
public class PBDWriter extends BPELWriter {
	...
	protected Element process2XML(Process process) {
		...
		if (attrAbstProcProf == null || attrAbstProcProf.isEmpty()) {
			procElement.setAttribute("abstractProcessProfile",
					BPEL4ChorConstants.PBD_ABSTRACT_PROCESS_PROFILE);
		}
//		// remove the imports
//		NodeList imports = procElement.getElementsByTagName("import");
//		for (int i = 0; i < imports.getLength(); i++) {
//			Node imp = imports.item(i);
//			procElement.removeChild(imp);
//		}
//
//		// remove the partnerLinks
//		NodeList nodeList4PL = procElement.getElementsByTagName("partnerLinks");
//		if (nodeList4PL.getLength() > 0) {
//			Node partnerLinks = nodeList4PL.item(0);
//			procElement.removeChild(partnerLinks);
//		}
		return procElement;
	}
